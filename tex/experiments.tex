...
The prediction accuracy and categorical cross entropy for both classe are recorded for each epoch and seen in the learning curves in Figure \ref{fig:learning_curves} and \ref{fig:learning_curves_regularized}.
