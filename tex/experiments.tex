...
They are implemented in Python with the Theano and Lasagne library, using mini-batch gradient descent with the ADAM optimizer \cite{Kingma2014c}, with a batchsize of 10 and learningn rate of 0.005.  
...
\begin{figure*}
    \centering
    \includegraphics[width=.6\textwidth]{Reconstructions_cut}
