...
\begin{figure*}[h!]
	...
	\hspace*{\fill}
    \caption{Means over the three kinds of GRU weights (Update, Reset and Candidate), for \subcaptionref{fig:model_1:weights_pos:horz} horizontal weights $\mat{W}\idx{h}$ and \subcaptionref{fig:model_1:weights_pos:vert} vertical weights $\mat{W}\idx{x}$ recorded after each epoch.
 	}
